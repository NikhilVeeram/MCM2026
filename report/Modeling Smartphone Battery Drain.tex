...
\begin{itemize}
    \item \textbf{Observation:} Our model predicts a total drain time of 2.1 to 3.5 hours for continuous ultra-high performance gaming, correlating with GSMArena's real-world stress tests \cite{12}.
...
\subsection{Scenario B: Optimized "Eco" Mode (12-Hour Target)}
By applying Low Power Mode (LPM) and minimizing display APR ($\gamma < 0.2$).
\begin{itemize}
    \item \textbf{Inputs:} Brightness 30\%, Dark Mode, Wi-Fi.
    \item \textbf{Result:} Time-to-Empty (TTE) extends to approximately 11.8 hours, validating the efficacy of our derivation in Equation (12).
\end{itemize}
