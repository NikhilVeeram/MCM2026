...
\begin{figure}[H]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \fbox{\parbox[c][7cm]{0.95\textwidth}{\centering \vspace{3cm} \textbf{Screenshot A1} \\ android\_eco\_dark\_50.png \vspace{3cm}}}
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \fbox{\parbox[c][7cm]{0.95\textwidth}{\centering \vspace{3cm} \textbf{Screenshot A2} \\ android\_light\_full.png \vspace{3cm}}}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \fbox{\parbox[c][7cm]{0.95\textwidth}{\centering \vspace{3cm} \textbf{Screenshot A3} \\ android\_dashboard\_top.png \vspace{3cm}}}
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \fbox{\parbox[c][7cm]{0.95\textwidth}{\centering \vspace{3cm} \textbf{Screenshot A4} \\ android\_dashboard\_bottom.png \vspace{3cm}}}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \fbox{\parbox[c][7cm]{0.95\textwidth}{\centering \vspace{3cm} \textbf{Screenshot I1} \\ ios\_eco\_profile.png \vspace{3cm}}}
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \fbox{\parbox[c][7cm]{0.95\textwidth}{\centering \vspace{3cm} \textbf{Screenshot I2} \\ ios\_power\_profile.png \vspace{3cm}}}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \fbox{\parbox[c][7cm]{0.95\textwidth}{\centering \vspace{3cm} \textbf{Screenshot I3} \\ ios\_wifi\_toggle.png \vspace{3cm}}}
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \fbox{\parbox[c][7cm]{0.95\textwidth}{\centering \vspace{3cm} \textbf{Screenshot I4} \\ ios\_gaming\_load.png \vspace{3cm}}}
