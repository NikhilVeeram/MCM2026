...
\begin{itemize}[nosep]
\item \textbf{OLED Display Optimization:} Dark mode reduces Active Pixel Ratio ($\alpha$: 0.8$\rightarrow$0.1), yielding \textbf{39--47\% energy savings} [5] by lowering pixel emission current.
