...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{../images/power_user_composite.png}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=0.95\textwidth]{../images/ios_power_profile.png}
        \caption{iOS: Power 1.5x Profile.}
    \end{minipage}
    \hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=0.95\textwidth]{../images/ios_eco_profile.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{../images/battery_scenario_grid.png}
