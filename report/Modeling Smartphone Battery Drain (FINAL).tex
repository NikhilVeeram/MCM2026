...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{../images/2RC_fig.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{../images/model_physics_curves.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{../images/power_user_composite.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{../images/limited_user_composite.png}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[height=6.2cm, keepaspectratio]{../images/ios_power_profile.png}
        \caption{iOS: Power 1.5x Profile.}
    \end{minipage}
    \hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[height=6.2cm, keepaspectratio]{../images/ios_eco_profile.png}
        \caption{iOS: Eco 1.5x Profile.}
    \end{minipage}
    \vspace{0.5em}
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[height=6.2cm, keepaspectratio]{../images/ios_gaming_load.png}
        \caption{iOS: Gaming Load.}
    \end{minipage}
    \hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[height=6.2cm, keepaspectratio]{../images/ios_wifi_toggle.png}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[height=6.2cm, keepaspectratio]{../images/android_dashboard_top.png}
        \caption{Dashboard (Top)}
    \end{minipage}
    \hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[height=6.2cm, keepaspectratio]{../images/android_dashboard_bottom.png}
        \caption{Dashboard (Bottom)}
    \end{minipage}
    \vspace{0.5em}
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[height=6.2cm, keepaspectratio]{../images/android_light_full.png}
        \caption{Light Mode (100\%)}
    \end{minipage}
    \hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[height=6.2cm, keepaspectratio]{../images/android_eco_dark_50.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{../images/battery_scenario_grid.png}
